      ...
      await $axios.interceptors.response.use((response) => {
        return response;
          ...
          switch (error.response.status) {
              case 401: // Нет авторизации
              case 419: // Сессия закончилась
              case 503: // Тех.обслуживание
                  // Перенаправить пользователя на экран входа в систему
                  this.resetState()
              ...
              case 500:
                  ...
                  break;
              default:
                  // Разрешить отдельным запросам обрабатывать другие ошибки
